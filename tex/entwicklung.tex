...
\subsection{Agenten}
Aus den Nicht-Funktionalen Anforderungen und den Funktionen lassen sich die folgenden Agenten im MRS extrahieren. Diese Agenten bestehen aus den Sensoren aus Kapitel \ref{sec:aufbau-sensoren} und den Robotern Rose und Dummy. Für Funktionen bei denen unterschiedliche Sensoren zur Verfügung stehen werden Tests vorgestellt. Diese begründen, warum ein Sensor dem anderen vorgezogen wurde.

\paragraph{Roboter} Die beiden Roboter
